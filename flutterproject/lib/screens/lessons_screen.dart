...
class _LessonsScreenState extends State<LessonsScreen> with TickerProviderStateMixin {
  ...
  Future<void> _loadLessons() async {
    ...
    try {
      final response = await _contentService.getLessonsByGroup(
  ...
  Widget _buildLessonCard(Lesson lesson, int index) {
    ...
    return GestureDetector(
      onTap: () {
        // Ders seçildiğinde etkinlikler ekranına git
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => ActivitiesScreen(lesson: lesson),
          ),
        );
      },
      child: Container(
